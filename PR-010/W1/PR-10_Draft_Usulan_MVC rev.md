...
**Catatan pasca-audit eksternal (lih. `PR-10_Analisis_Topik.md`, catatan koreksi putaran ketiga):** "Teorema Fermat Terakhir" sempat salah dinilai Keep:Sekunder krn Konsensus-nya tertukar dgn Tokoh "Pierre de Fermat" (8/12, seharusnya 3/12) — sudah dikoreksi ke Optional. Draft MVC ini **tidak diubah** menyusul koreksi itu: penyebutan FLT di Bab 1 (2 kalimat, sbg jembatan naratif dari Diophantus ke era modern) tetap dipertahankan krn statusnya sbg ilustrasi singkat dlm bab yang sudah dijustifikasi topik lain (Persamaan Diophantine, Primer) — bukan sbg bagian berdiri sendiri yg butuh status Sekunder utk dibenarkan. Prinsip yg sama berlaku umum: status Optional berarti "jangan bangun bagian di sekitar ini", bukan "jangan pernah disebut sama sekali".
