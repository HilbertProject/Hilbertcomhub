...
>
> **Catatan koreksi (putaran ketiga, dari jendela Audit Konsistensi Eksternal — `PR-010_W1_Audit-Konsistensi-Eksternal.md`):** 1 error data ditemukan & dikonfirmasi ulang independen ke sheet mentah sebelum diperbaiki — baris "Teorema Fermat Terakhir" salah memakai Konsensus milik Tokoh "Pierre de Fermat" (8/12) alih-alih milik Topik itu sendiri (**3/12**, dikonfirmasi ulang: hanya CO/KI/ME yang menyebutnya). Karena rubrik §2 Keputusan Editorial menurunkan Rekomendasi langsung dari angka Konsensus, kesalahan angka ini berdampak: dengan 3/12 (bukan 8/12), ambang "Rendah+Konsensus≥4→Sekunder" tidak terpenuhi, jadi Rekomendasi kembali ke **Optional** — pembalikan penuh dari revisi putaran kedua sebelumnya, bukan cuma perbaikan kosmetik. Audit yang sama juga menemukan 2 kesalahan hitung di `PR-10_Verifikasi_Mandiri.md` (lihat catatan di kepala dokumen itu) dan mengonfirmasi 97/98 baris lain + seluruh statistik headline lain di dokumen ini **cocok persis** ke data mentah — volume konfirmasi jauh lebih besar dari temuan masalah.
...
| Teorema Fermat Terakhir (contoh motivasi historis) *(KOREKSI — Konsensus sebelumnya salah tertukar dgn Tokoh "Pierre de Fermat" [8/12]; angka benar dicek ulang ke sheet mentah)* | Pierre de Fermat, Andrew Wiles | 3/12 | Rendah | Contoh populer persamaan Diophantine termasyhur lain, tak terkait mekanisme PR-10 — dgn Konsensus benar (3/12, bukan 8/12) berada DI BAWAH ambang rubrik §2 (Rendah+Konsensus≥4→Sekunder), jadi kembali ke Optional | Optional |
